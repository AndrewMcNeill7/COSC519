...
def create_file(directory, file_name="example", file_extension=".txt"):
    ...
    with open(file_path, 'w') as f:
        f.write(f"This is an example {file_extension} file created inside the new folder.")
    return file_path
...
def main():
    ...
    file_extension = input("Enter the file extension (e.g., .txt, .csv, .json): ")

    # Create the file with the user's inputs
    created_file = create_file(directory, file_name=file_name, file_extension=file_extension)
