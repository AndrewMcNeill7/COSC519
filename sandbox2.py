...
class FileExplorer(tk.Tk):
    def __init__(self):
        ...
        self.back_button = ttk.Button(self.toolbar, text="Back", command=self.go_back)
    ...
    def go_back(self):
        ...
        if self.previous_directories:
            self.current_directory = self.previous_directories.pop()
            self.update_file_list(self.current_directory)
            self.tree.selection_set("")  # Clear selection in the tree
